...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen pl-[8cm] pr-[8cm] pt-[2cm]">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="grid grid-cols-2 gap-20 mt-5">
              <input
                ...
                className="p-2 bg-gray-100 border border-gray-600 rounded-2xl"
              />
              {/* This empty div ensures the email field matches the size of the previous inputs */}
              <div></div>
            </div>
          </div>
        </div>
