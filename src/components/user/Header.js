      ...
      <header className="sticky top-0 z-50 py-4 bg-white shadow-md">
        <div className="container relative flex items-center justify-between mx-auto">
          ...
          {isLoggedIn ? (
              ...
              <Link to="/signUp">
                <button
                    className="m-2 p-1 pl-5 pr-5 w-[auto] text-lg font-semibold text-white transition duration-300 ease-in-out bg-black shadow rounded-full hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
                  Sign in
                </button>
              </Link>
          )}
